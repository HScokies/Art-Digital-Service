...
const UpdateStaffForm = ({ formId, entityId }: IUpdateForm) => {
    ...
    return (
        ...
        <form id={formId} onSubmit={(e) => handleSubmit(e)}>
            ...
            <Input label='Фамилия сотрудника' type='text' name='lastName' maxlength={17} defaultValue={staff?.lastName} required />
            <Input label='Имя сотрудника' type='text' name='firstName' maxlength={17} defaultValue={staff?.firstName} required />
